...
<head>
    ...
    <script>
        function editUser(userCategoryID) {
            const url = 'edit.php?id=' + userCategoryID;
            console.log('Redirecting to: ' + url); // In URL ra để kiểm tra
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="text-end mt-2">
                    <!-- Added a separate div for alignment -->
                    <a class="btn btn-success border border-success text-white" href="create.php">+</a>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                    <a href='edit_usercategories.php?id={$row['UserCategoryID']}' class='btn btn-outline-primary'>Edit</a>
    ...
    <script src="../UI/js/bootstrap.bundle.min.js"></script> <!-- Thay đổi đường dẫn đến tệp JS nếu cần -->
</body>
